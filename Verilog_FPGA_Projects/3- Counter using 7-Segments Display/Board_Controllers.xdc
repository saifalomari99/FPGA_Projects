...
##Switches
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { resetSW }]; #I made this into a reset switch for clk
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { resetSWCo }];  #I made this reset for counter
...
set_property -dict { PACKAGE_PIN J13   IOSTANDARD LVCMOS33 } [get_ports { Q[2] }]; #Test Light 3
...
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { outsignal }]; 
