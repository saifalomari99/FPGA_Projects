...
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { stopSongSW }]; 
#set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { stopSongSW }]; #IO_L6N_T0_D08_VREF_14 Sch=sw[2]
