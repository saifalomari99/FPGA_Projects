...
##Switches
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { reset1HzclkSW }]; #I made this into a reset switch for clk
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { reset400HzclkSW }];  #I made this reset for counter
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { resetCounterSW }]; #reset 2-bit counter
...
## LEDs
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { seconds[0] }];   #Test Lights for the seconds
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { seconds[1] }]; 
set_property -dict { PACKAGE_PIN J13   IOSTANDARD LVCMOS33 } [get_ports { seconds[2] }]; 
set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports { seconds[3] }]; 
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { seconds[4] }]; 
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { seconds[5] }]; 
#set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { seconds[2] }]; 
set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS33 } [get_ports { minutes[0] }];    #Test lights for the minutes
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { minutes[1] }]; 
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { minutes[2] }]; 
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { minutes[3] }]; 
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { minutes[4] }]; 
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { minutes[5] }]; 
#set_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports { LED[13] }]; #IO_L22N_T3_A04_D20_14 Sch=led[13]
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { clk400HzOutsignal }];
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { clk1HzOutsignal }]; 
...
# Display Colons
#set_property -dict { PACKAGE_PIN = U16; IOSTANDARD = LVCMOS33; } [get_ports { led_disp_anode[0] }]
#set_property -dict { PACKAGE_PIN = U18; IOSTANDARD = LVCMOS33; } [get_ports { led_disp_anode[1] }]
